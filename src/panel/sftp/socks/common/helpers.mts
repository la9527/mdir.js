import {
    ...
    SocksRemoteHost,
} from "../client/socksclient.mjs";
import {SocksClientError} from "./util.mjs";
import {ERRORS, SocksCommand, SocksProxy} from "./constants.mjs";
...
function isValidSocksProxy(proxy: SocksProxy) {
    return (
        proxy &&
    (typeof proxy.host === "string" || typeof (proxy as any).ipaddress === "string") &&
