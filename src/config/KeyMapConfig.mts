...
import { IFrameMenuConfig, ISubMenuConfig } from "./MenuConfig.mjs";
...
export const TerminalAllowKeys = [ "C-q", "C-e", "C-w", "C-o", "C-b", "C-f", "C-u", "C-up", "C-down", "S-up", "S-down", "M-f", "M-b" ];
